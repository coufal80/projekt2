...
if (isset($_GET['odstranit']))
    $spravceKlientu->odstran($_GET['odstranit']);

$klienti = $spravceKlientu->vratKlienta();
...
<table class="tabulka">
    ...
    <?php foreach ($klienti as $klient): ?>
        ...
        <tr>
            ...
            <td><a href="detail.php?detail=<?= htmlspecialchars($klient['klient_id']) ?>">Detail</a></td>
            <td><a href="klienti.php?editovat=<?= htmlspecialchars($klient['klient_id']) ?>">Edit</a></td>
            <td><a href="klienti_vypis.php?odstranit=<?= htmlspecialchars($klient['klient_id']) ?>">X</a></td>
        </tr>
